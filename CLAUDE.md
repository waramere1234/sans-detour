...
`npm run test:run` (Vitest, ~317 tests aujourd'hui couvrant matching / deck / session / parties / personnalites / analytics / themes / Card / ChipTop1 / Cover / MethodeSheet / ErrorBoundary / FreshnessBanner / compute-positions / sanity / deck-invariants / parse-summary / contact / nav-state / text-cleanup / an-filter / an-parse / env / useModalA11y / useFreshnessOnce / useFlipCardA11y / PartyRow / PersonnaliteRow / Wordmark, doivent rester verts à chaque commit).
