...
`npm run test:run` (Vitest, ~412 tests aujourd'hui couvrant matching / deck / session / parties / personnalites / analytics / themes / Card / ChipTop1 / Cover / Legal / Methode / MethodeSheet / ErrorBoundary / FreshnessBanner / Skeleton / compute-positions / sanity / deck-invariants / parse-summary / contact / nav-state / routes / scrutins / text-cleanup / an-filter / an-parse / an-personnalites / env / useModalA11y / useFreshnessOnce / useFlipCardA11y / AuditTrail / DeckStack / PartyRow / PersonnaliteRow / RankingOverlay / TopBar / Wordmark, doivent rester verts à chaque commit).
